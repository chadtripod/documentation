...
* Deploying Spinnaker AWS Provider for ec2 and ecs deployments

* Configuring Spinnaker Managing Policy for Spinnaker
* Creating a Managed Account IAM Role in each your target AWS Accounts (ecs) - Multiple needed if you have multiple AWS accounts
* 
