...
***Note*** purpose should be left and the subnet identifier should replace "example-purpose".  This will show up in Spinnaker UI. i.e. immutable_metadata={"purpose":"us-west-2-dev-subnet"}
